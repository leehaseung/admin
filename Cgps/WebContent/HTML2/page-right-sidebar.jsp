                                                    ...
                                                    <ul class="sub-menu">
                                                        <li>
                                                            ...
                                                            <ul class="sub-menu">
                                                                ...
                                                                <li><a class="current" href="page-right-sidebar.html">Right Sidebar Page</a></li>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="v-animation" data-animation="fade-in" data-delay="200">
                            ...
                            <figure class="lightbox animated-overlay overlay-alt clearfix">
                                <img width="2000" height="957" src="img/static/22.jpg" class="attachment-full" />
                                <a class="view" href="img/static/22.jpg" rel="image-gallery"></a>
                                <figcaption>
