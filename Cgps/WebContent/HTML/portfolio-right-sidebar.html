...
<body>
                        ...
                        <ul class="nav nav-pills nav-main" id="mainMenu">
                            ...
                            <li class="dropdown active">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-submenu">
                                        <a href="#" class="current">Portfolio Variations</a>
                                        <ul class="dropdown-menu">
                                            <li><a class="current" href="portfolio-right-sidebar.html">Right Sidebar Portfolio</a></li>
    ...
    <div id="container" style="background: transparent url('img/base/page_bkg.png') repeat center top; background-size: auto;">

        <div class="v-page-heading v-bg-stylish v-bg-stylish-v9">
            <div class="container">
                <div class="row">

                    <div class="col-sm-12">
                        <div class="heading-text">
                            <h1 class="entry-title">Portfolio Right Sidebar</h1>
                        </div>
                    ...
                    <div class="col-sm-9">
                        <div class="v-portfolio-wrap">
                            ...
                            <ul class="v-portfolio-items masonry-items masonry-fw filterable-items col-3 row clearfix">
                                <li class="clearfix v-portfolio-item col-sm-4 masonry-item masonry-gallery-item  business">
                                ...
                                <li class="clearfix v-portfolio-item col-sm-4 masonry-item masonry-gallery-item  lifestyle creation">
                                    <figure class="animated-overlay">
                                        <img src="img/masonry/06.jpg" />
                                        <a href="portfolio-single.html" class="link-to-post"></a>
                                        <figcaption>
                                            <div class="thumb-info thumb-info-v2"><i class="fa fa-angle-right"></i></div>
                                        </figcaption>
                                ...
                                <li class="clearfix v-portfolio-item col-sm-4 masonry-item masonry-gallery-item  creation">
                                    <figure class="animated-overlay">
                                        <img src="img/masonry/03.jpg" />
                                        <a href="portfolio-single.html" class="link-to-post"></a>
                                        <figcaption>
                                            <div class="thumb-info thumb-info-v2"><i class="fa fa-angle-right"></i></div>
                                        </figcaption>
                                ...
                                <li class="clearfix v-portfolio-item col-sm-4 masonry-item masonry-gallery-item  lifestyle creation nature business">
                                    <figure class="animated-overlay">
                                        <img src="img/masonry/02.jpg" />
                                        <a href="portfolio-single.html" class="link-to-post"></a>
                                        <figcaption>
                                            <div class="thumb-info thumb-info-v2"><i class="fa fa-angle-right"></i></div>
                                        </figcaption>
                                ...
                                <li class="clearfix v-portfolio-item col-sm-4 masonry-item masonry-gallery-item  beautiful nature">
                                    <figure class="animated-overlay">
                                        <img src="img/masonry/08.jpg" />
                                        <a href="portfolio-single.html" class="link-to-post"></a>
                                        <figcaption>
                                            <div class="thumb-info thumb-info-v2"><i class="fa fa-angle-right"></i></div>
                                        </figcaption>
                                ...
                                <li class="clearfix v-portfolio-item col-sm-4 masonry-item masonry-gallery-item  nature lifestyle">
                                    <figure class="animated-overlay">
                                        <img src="img/masonry/05.png" />
                                        <a href="portfolio-single.html" class="link-to-post"></a>
                                        <figcaption>
                                            <div class="thumb-info thumb-info-v2"><i class="fa fa-angle-right"></i></div>
                                        </figcaption>
                                    ...
                                    <div class="v-portfolio-item-info">
                                        ...
                                        <h3 class="v-portfolio-item-title">
                                            <a href="portfolio-single.html" class="link-to-post">Faucibus Pretium</a>
                                        </h3>
                                ...
                                <li class="clearfix v-portfolio-item col-sm-4 masonry-item masonry-gallery-item  beautiful nature">
                                    <figure class="animated-overlay">
                                        <div class="flexslider thumb-slider">
                                            <ul class="slides">
                                                <li>
                                                    <a href="portfolio-single-fw-slides.html" class="link-to-post">
                                                        <img src='img/static/bus-4.jpg' />
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="portfolio-single-fw-slides.html" class="link-to-post">
                                                        <img src='img/static/bus-7.jpg' />
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <li class="clearfix v-portfolio-item col-sm-4 masonry-item masonry-gallery-item  nature lifestyle beautiful">
                                    <figure class="animated-overlay">
                                        <img src="img/static/bus-13.jpg" />
                                        <a href="portfolio-single.html" class="link-to-post"></a>
                                        <figcaption>
                                            <div class="thumb-info thumb-info-v2"><i class="fa fa-angle-right"></i></div>
                                        </figcaption>
                                    ...
                                    <div class="v-portfolio-item-info">
                                        ...
                                        <h3 class="v-portfolio-item-title">
                                            <a href="portfolio-single.html" class="link-to-post">Lordani Samantipos</a>
                                        </h3>
                                        <h5 class="v-portfolio-subtitle">Nature</h5>
                                    </div>
                                </li>
                                ...
                                <li class="clearfix v-portfolio-item col-sm-4 masonry-item masonry-gallery-item  creation">
                                    ...
                                    <div class="v-portfolio-item-info">
                                        ...
                                        <h3 class="v-portfolio-item-title">
                                            <a href="portfolio-single.html" class="link-to-post">Mado Pali Somantos</a>
                                        </h3>
                                        <h5 class="v-portfolio-subtitle">Creation</h5>
                                    </div>
                                </li>
                                ...
                                <li class="clearfix v-portfolio-item col-sm-4 masonry-item masonry-gallery-item  business">
                                    ...
                                    <div class="v-portfolio-item-info">
                                        ...
                                        <h3 class="v-portfolio-item-title">
                                            <a href="portfolio-single.html" class="link-to-post">Bangomasto Silomason</a>
                                        </h3>
                                        <h5 class="v-portfolio-subtitle">Business</h5>
                                    </div>
                                </li>
                            ...
                            <section class="widget">
                                ...
                                <div class="footer-contact-info">
                                    <ul>
                                        ...
                                        <li>
                                            <p><i class="fa fa-skype"></i><a href="mailto:mail@example.com">venuetheme</a></p>
                                        </li>
                                    </ul>
                                    <br />
