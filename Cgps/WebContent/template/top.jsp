                ...
                <div class="navbar-collapse nav-main-collapse collapse">
                    ...
                    <nav class="nav-main mega-menu">
                        <ul class="nav nav-pills nav-main" id="mainMenu">
                                ...
                                <a class="dropdown-toggle" href="#">GPS <i class="fa fa-caret-down"></i></a>
                                                    ...
                                                    <ul class="sub-menu">
                                                        <li>
                                                            ...
                                                            <ul class="sub-menu">
                                                                ...
                                                                <li><a href="page-right-sidebar.jsp">Right Sidebar Page</a></li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="element-maps.jsp">Google Maps</a></li>
                                </ul>
                            </li>
                            <li class="dropdown mega-menu-item mega-menu-fullwidth">
