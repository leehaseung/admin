...
public class Board {
	 private int board_num;          // 글번호
	    ...
	    private int board_parent;	//부모글 번
		...
		public String toString() {
			return "Board [board_num=" + board_num + ", board_id=" + board_id + ", board_subject=" + board_subject
					+ ", board_content=" + board_content + ", board_file=" + board_file + ", board_re_ref="
					+ board_re_ref + ", board_re_lev=" + board_re_lev + ", board_re_seq=" + board_re_seq
